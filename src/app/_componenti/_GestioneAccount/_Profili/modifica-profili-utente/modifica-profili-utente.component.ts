...
@Component({
  selector: 'app-modifica-profili-utente', // Kept the selector unchanged
  templateUrl: './modifica-profili-utente.component.html', // Kept the template URL unchanged
  styleUrls: ['./modifica-profili-utente.component.scss'] // Kept the style URL unchanged
})
