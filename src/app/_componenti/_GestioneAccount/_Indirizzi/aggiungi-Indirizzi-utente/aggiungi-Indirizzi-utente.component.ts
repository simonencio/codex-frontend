...
@Component({
  selector: 'app-aggiungi-indirizzi-utente', // Keeping the original selector
  templateUrl: './aggiungi-indirizzi-utente.component.html', // Keeping the original template URL
  styleUrls: ['./aggiungi-indirizzi-utente.component.scss'] // Keeping the original style URL
})
export class AggiungiIndirizziComponent implements OnInit, OnDestroy {
  ...
  constructor(private api: ApiService, private fb: FormBuilder) {
    this.registrationForm = this.fb.group({
      ...
      idContatto: [{ value: null, disabled: true }, Validators.required], // Set as disabled
  ...
  ngOnInit(): void {
    ...
    this.registrationForm.get('idContatto')?.setValue(this.loggedInIdContatto); // Set the idContatto in the form
