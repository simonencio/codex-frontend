...
@Component({
  selector: 'app-modifica-recapiti', // Kept the selector unchanged
  templateUrl: './modifica-recapiti.component.html', // Kept the template URL unchanged
  styleUrls: ['./modifica-recapiti.component.scss'] // Kept the style URL unchanged
})
