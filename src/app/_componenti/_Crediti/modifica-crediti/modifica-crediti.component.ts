...
@Component({
  selector: 'app-modifica-crediti', // Kept the selector unchanged
  templateUrl: './modifica-crediti.component.html', // Kept the template URL unchanged
  styleUrls: ['./modifica-crediti.component.scss'] // Kept the style URL unchanged
})
